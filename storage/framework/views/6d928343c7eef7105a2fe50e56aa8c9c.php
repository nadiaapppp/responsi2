        ...
        <div class="ml-auto">
            <?php if(Route::has('login')): ?>
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <a href="<?php echo e(url('/dashboard')); ?>" class="text-gray-700 hover:text-primary">Dashboard</a>

                    <!-- Link Admin hanya untuk pengguna dengan peran 'admin' -->
                    <?php if(Auth::user()->role == 'admin'): ?>
                        <a href="<?php echo e(url('/admin')); ?>" class="ml-4 text-gray-700 hover:text-primary">Admin</a>
                    <?php endif; ?>
                <?php else: ?>
                    <!-- Link Login -->
                    <a href="<?php echo e(route('login')); ?>" class="text-gray-700 hover:text-primary">Log in</a>
                    
                    <!-- Link Register -->
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="ml-4 text-gray-700 hover:text-primary">Register</a>
                    <?php endif; ?>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-[#85A98F] rounded-xl shadow-lg p-6 hover:shadow-2xl transition transform hover:-translate-y-1 flex flex-col">
        <div class="h-48 bg-gray-300 rounded-md mb-4 overflow-hidden">
            <img src="<?php echo e(asset('images/product1.jpg')); ?>" alt="Produk 1" class="w-full h-full object-cover rounded-md">
        </div>
    ...
    <div class="bg-[#85A98F] rounded-xl shadow-lg p-6 hover:shadow-2xl transition transform hover:-translate-y-1 flex flex-col">
        <div class="h-48 bg-gray-300 rounded-md mb-4 overflow-hidden">
            <img src="<?php echo e(asset('images/product2.jpg')); ?>" alt="Produk 2" class="w-full h-full object-cover rounded-md">
        </div>
    ...
    <div class="bg-[#85A98F] rounded-xl shadow-lg p-6 hover:shadow-2xl transition transform hover:-translate-y-1 flex flex-col">
        <div class="h-48 bg-gray-300 rounded-md mb-4 overflow-hidden">
            <img src="<?php echo e(asset('images/product3.jpg')); ?>" alt="Produk 3" class="w-full h-full object-cover rounded-md">
        </div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-[#85A98F] rounded-xl shadow-lg p-6 hover:shadow-2xl transition transform hover:-translate-y-1 flex flex-col">
        <div class="h-48 bg-gray-300 rounded-md mb-4 overflow-hidden">
            <img src="<?php echo e(asset('images/ui.jpg')); ?>" alt="Makanan 1" class="w-full h-full object-cover rounded-md">
        </div>
    ...
    <div class="bg-[#85A98F] rounded-xl shadow-lg p-6 hover:shadow-2xl transition transform hover:-translate-y-1 flex flex-col">
        <div class="h-48 bg-gray-300 rounded-md mb-4 overflow-hidden">
            <img src="<?php echo e(asset('images/cr.jpg')); ?>" alt="Makanan 2" class="w-full h-full object-cover rounded-md">
        </div>
    ...
    <div class="bg-[#85A98F] rounded-xl shadow-lg p-6 hover:shadow-2xl transition transform hover:-translate-y-1 flex flex-col">
        <div class="h-48 bg-gray-300 rounded-md mb-4 overflow-hidden">
            <img src="<?php echo e(asset('images/tr.jpg')); ?>" alt="Makanan 3" class="w-full h-full object-cover rounded-md">
        </div>
...
<?php /**PATH C:\xampp\htdocs\warungvrl\resources\views/welcome.blade.php ENDPATH**/ ?>