<form method="POST" action="<?php echo e(route('register')); ?>" style="max-width: 400px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\warungvrl\resources\views/auth/register.blade.php ENDPATH**/ ?>