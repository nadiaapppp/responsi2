<form method="POST" action="<?php echo e(route('login')); ?>" style="max-width: 400px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group" style="margin-bottom: 15px; text-align: right;">
        <?php if(Route::has('password.request')): ?>
            <a href="<?php echo e(route('password.request')); ?>" style="text-decoration: none; color: #2c3e50; font-size: 14px;">Forgot your password?</a>
        <?php endif; ?>
    </div>
...
<?php /**PATH C:\xampp\htdocs\warungvrl\resources\views/auth/login.blade.php ENDPATH**/ ?>