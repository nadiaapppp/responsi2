...
<body class="custom-gray text-gray-800">
    ...
    <header class="custom-green shadow-md py-4">
        <div class="container mx-auto flex justify-between items-center px-6">
            ...
            <div>
                <a href="<?php echo e(url('/')); ?>" class="text-white hover:underline hover:text-gray-300">Home</a>
                <a href="<?php echo e(route('logout')); ?>" class="ml-4 text-white hover:underline hover:text-gray-300"
...
<?php /**PATH C:\xampp\htdocs\warungvrl\resources\views/dashboard.blade.php ENDPATH**/ ?>